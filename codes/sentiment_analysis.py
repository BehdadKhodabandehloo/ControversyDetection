    ...
    for file in ['germanwings_data', 'indiana_data', 'indiasdaughter_data', 'leadersdebate_data', 'mothersday_data']:
        ...
        for graph_type in ['mention', 'reply']:
            ...
            for sent in ['pos', 'neg']:
                ...
                plt.savefig('%s%s_%s_%s_percentage.png' % (dir_result, file, graph_type, sent))
                ...
                plt.savefig('%s%s_%s_%s_count.png' % (dir_result, file, graph_type, sent))
                plt.clf()
